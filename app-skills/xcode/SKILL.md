...
- Commit: Source Control > Commit, option-command-C.
...
- On the newest Xcode the source control menu may appear under a different name; look for Source Control or Integrate in the menu bar and describe it as "the source control menu" if unsure.
