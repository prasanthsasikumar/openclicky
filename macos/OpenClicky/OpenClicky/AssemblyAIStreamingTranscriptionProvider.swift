...
final class AssemblyAIStreamingTranscriptionProvider: BuddyTranscriptionProvider {
    ...
    private static var tokenProxyURL: String { "\(OpenClickyConfiguration.backendBaseURL)/transcribe-token" }
...
private final class AssemblyAIStreamingTranscriptionSession: NSObject, BuddyStreamingTranscriptionSession {
    ...
    private let stateQueue = DispatchQueue(label: "com.openclicky.assemblyai.state")
    private let sendQueue = DispatchQueue(label: "com.openclicky.assemblyai.send")
